...
export const MobileNav: React.FC<MobileNavProps> = ({
  ...
  return (
    <div className={`fixed bottom-0 left-0 right-0 z-50 border-t border-[var(--border)] bg-[var(--background)]/90 backdrop-blur-md px-4 py-2 md:hidden flex justify-around items-center shadow-lg ${className}`}>
      ...
      <Link
        ...
        className={`flex flex-col items-center justify-center p-1.5 transition-colors ${
          activePath === "/" || activePath === "/feed" ? "text-[#6366F1]" : "text-[var(--text-muted)] hover:text-violet-400"
        }`}
      ...
      <Link
        href="/explore"
        className={`flex flex-col items-center justify-center p-1.5 transition-colors ${
          activePath === "/explore" ? "text-[#6366F1]" : "text-[var(--text-muted)] hover:text-violet-400"
        }`}
        aria-label="Explore"
      >
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-6 w-6">
      ...
      <Link
        ...
        className={`relative flex flex-col items-center justify-center p-1.5 transition-colors ${
          activePath === "/notifications" ? "text-[#6366F1]" : "text-[var(--text-muted)] hover:text-violet-400"
        }`}
      ...
      <Link
        href="/analytics"
        className={`flex flex-col items-center justify-center p-1.5 transition-colors ${
          activePath === "/analytics" ? "text-[#6366F1]" : "text-[var(--text-muted)] hover:text-violet-400"
        }`}
